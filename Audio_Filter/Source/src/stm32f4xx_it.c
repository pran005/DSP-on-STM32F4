...
volatile uint8_t LED_Toggle , LED_RED;
...
void SysTick_Handler(void)
{
    ...
    if ((user_mode & 2) && !(tick & 0x3f) ||
        !(user_mode & 2) && !(tick & 0x7f))
